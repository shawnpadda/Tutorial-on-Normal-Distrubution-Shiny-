...
ui <- dashboardPage(  
            ...
            fluidRow(  
              box(
                ...
                selectInput(inputId = "bins",
                                       ...
                                       choices = c(6,10,16,20), selected = 20),
            ...
            fluidRow(
              box(
               ...
               numericInput(inputId = "M",
                               ...
                               value = 247, min = 1, max = 247),
               numericInput(inputId = "siz",
                            label = "Choose a size of the density curve:",
                            value = 2, min = 1, max = 3),
               selectInput(inputId = "Col",
                              label = "Choose a color:",
                              choices = c("blue","limegreen","khaki", 
                                          "tan","rosybrown"), 
                        selected = "blue"),height = 300),
        tabBox(
 ...
 server <- function(input, output){
      ...
      output$plot <- renderPlot({
          ...
          labs(title = "Histogram of simulated data set" ,
               subtitle = paste("A bar graph of",input$n,"observations"), x = "x", 
               y ="Density", x = " ") + 
